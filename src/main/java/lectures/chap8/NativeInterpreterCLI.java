...
import com.cognac.wine.sementics.parser.ClosureParser;
...
public class NativeInterpreterCLI {
    public static void main(String[] args) throws ParseException{
        ...
        ClosureParser bp = new ClosureParser();
        ExecEnvStorage env = new Natives().environment(new NestedExecEnvStorage());
